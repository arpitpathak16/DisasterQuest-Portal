            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 my-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium">{user.progress.preparation}%</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium">{user.progress.response}%</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium">{user.progress.restoration}%</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium">{user.progress.recovery}%</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium">{user.progress.mitigation}%</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium">{user.progress.capacity}%</p>
                </div>
              </div>
            </div>
          </div>
